 ...
 * 2016-08-28 2.7 TC remove volume control disable when rotary encoder
 *
 */
...
jQuery(document).ready(function($) { 'use strict';
	...
	// connect shairport-sync metadata engine
	if (SESSION.json['airplaymeta'] == '1') {
		engineSps();
	}
